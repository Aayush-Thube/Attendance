# app.py
"""
Attendance app (Excel only; auto sheet rollover + old data cleanup).
- Auto-creates `attendance_system.xlsx` on first run.
- Attendance + Edit Logs with date-range downloads.
- Admin Dashboard access = Role:Admin OR Whitelisted phone.
- Admins can edit attendance → logs written to `attendance_edits`.
"""
